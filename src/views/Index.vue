        ...
        <v-row justify="center" align="center">
            <v-card class="card" :loading="isAjax">
                ...
                <v-card-text v-show="state==='form'">
                  <p>Drops are limited to <b>1 request per hour</b>.<br>If larger allocation is needed please contact us on <a href="https://discord.com/invite/RwXY7P6" target="_blank">Discord</a></p>
                    <div>
